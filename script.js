...
'<div class="survey-question"><p class="question-text">Q1. 実験は楽しかったか</p><div class="likert-scale"><span>全くそう思わない</span><div class="likert-options"><label><input type="radio" name="q1" value="1" required><span>1</span></label><label><input type="radio" name="q1" value="2"><span>2</span></label><label><input type="radio" name="q1" value="3"><span>3</span></label><label><input type="radio" name="q1" value="4"><span>4</span></label><label><input type="radio" name="q1" value="5"><span>5</span></label></div><span>非常にそう思う</span></div></div>' +
'<div class="survey-question"><p class="question-text">Q2. ディズニープリンセスは好きか（5段階）</p><div class="likert-scale"><span>全く好きではない</span><div class="likert-options"><label><input type="radio" name="q2" value="1" required><span>1</span></label><label><input type="radio" name="q2" value="2"><span>2</span></label><label><input type="radio" name="q2" value="3"><span>3</span></label><label><input type="radio" name="q2" value="4"><span>4</span></label><label><input type="radio" name="q2" value="5"><span>5</span></label></div><span>非常に好き</span></div></div>' +
'<div class="survey-question"><p class="question-text">Q3. ディズニー物語の中心は恋愛だと思いますか</p><div class="likert-scale"><div class="likert-options"><label><input type="radio" name="q3" value="5" required><span>とてもそう思う</span></label><label><input type="radio" name="q3" value="4"><span>そう思う</span></label><label><input type="radio" name="q3" value="3"><span>どちらでもない</span></label><label><input type="radio" name="q3" value="2"><span>そう思わない</span></label><label><input type="radio" name="q3" value="1"><span>全くそう思わない</span></label></div></div></div>' +
'<div class="survey-question"><p class="question-text">Q4. どのストーリーを知っていたか（複数選択可）</p><div class="checkbox-options"><label><input type="checkbox" name="q4[]" value="aurora">オーロラ姫（眠れる森の美女）</label><label><input type="checkbox" name="q4[]" value="annaandelsa">アナとエルサ（アナと雪の女王）</label><label><input type="checkbox" name="q4[]" value="rapunzel">ラプンツェル（塔の上のラプンツェル）</label><label><input type="checkbox" name="q4[]" value="snow_white">白雪姫</label><label><input type="checkbox" name="q4[]" value="jasmine">ジャスミン（アラジン）</label><label><input type="checkbox" name="q4[]" value="belle">ベル（美女と野獣）</label><label><input type="checkbox" name="q4[]" value="cinderella">シンデレラ</label><label><input type="checkbox" name="q4[]" value="moana">モアナ</label><label><input type="checkbox" name="q4[]" value="ariel">アリエル（リトル・マーメイド）</label></div></div>' +
'<div class="survey-question"><p class="question-text">Q5. 現代社会に合っていると思うプリンセスを選んでください（複数選択可）</p><div class="checkbox-options"><label><input type="checkbox" name="q5[]" value="aurora">オーロラ姫</label><label><input type="checkbox" name="q5[]" value="annaandelsa">アナとエルサ</label><label><input type="checkbox" name="q5[]" value="rapunzel">ラプンツェル</label><label><input type="checkbox" name="q5[]" value="snow_white">白雪姫</label><label><input type="checkbox" name="q5[]" value="jasmine">ジャスミン</label><label><input type="checkbox" name="q5[]" value="belle">ベル</label><label><input type="checkbox" name="q5[]" value="cinderella">シンデレラ</label><label><input type="checkbox" name="q5[]" value="moana">モアナ</label><label><input type="checkbox" name="q5[]" value="ariel">アリエル</label></div></div>' +
'<div class="survey-question"><p class="question-text">Q6. 子供に見せたいプリンセスの物語はどれか（1つ選択）</p><div class="radio-options"><label><input type="radio" name="q6" value="aurora" required>オーロラ姫（眠れる森の美女）</label><label><input type="radio" name="q6" value="annaandelsa">アナとエルサ（アナと雪の女王）</label><label><input type="radio" name="q6" value="rapunzel">ラプンツェル（塔の上のラプンツェル）</label><label><input type="radio" name="q6" value="snow_white">白雪姫</label><label><input type="radio" name="q6" value="jasmine">ジャスミン（アラジン）</label><label><input type="radio" name="q6" value="belle">ベル（美女と野獣）</label><label><input type="radio" name="q6" value="cinderella">シンデレラ</label><label><input type="radio" name="q6" value="moana">モアナ</label><label><input type="radio" name="q6" value="ariel">アリエル（リトル・マーメイド）</label></div></div>' +
'<div class="survey-question"><p class="question-text">Q7. 主にどこに着目して分類したか（1つ選択）</p><div class="radio-options"><label><input type="radio" name="q7" value="appearance" required>外見</label><label><input type="radio" name="q7" value="story">ストーリー</label><label><input type="radio" name="q7" value="personality">性格</label></div></div>' +
'<div class="survey-question"><p class="question-text">Q8. 昔と今のプリンセスの在り方は違うと思うか</p><div class="radio-options"><label><input type="radio" name="q8" value="yes" required>はい</label><label><input type="radio" name="q8" value="no">いいえ</label></div></div>' +
'<div class="survey-question"><p class="question-text">Q9. グループ分けの基準は一貫していたか、途中で変わったか</p><div class="radio-options"><label><input type="radio" name="q9" value="consistent" required>一貫していた</label><label><input type="radio" name="q9" value="changed">途中で変わった</label></div></div>' +
'<div class="survey-question"><p class="question-text">Q10. あなたのグループ分けは公開時期と関係あると思うか</p><div class="likert-scale"><span>全くそう思わない</span><div class="likert-options"><label><input type="radio" name="q10" value="1" required><span>1</span></label><label><input type="radio" name="q10" value="2"><span>2</span></label><label><input type="radio" name="q10" value="3"><span>3</span></label><label><input type="radio" name="q10" value="4"><span>4</span></label><label><input type="radio" name="q10" value="5"><span>5</span></label></div><span>非常にそう思う</span></div></div>' +
'<div class="survey-question"><p class="question-text">Q11. ディズニープリンセスらしさを一言で言うなら</p><input type="text" name="q11" required placeholder="例：夢を持って諦めない" style="width:100%;padding:8px;box-sizing:border-box;margin-top:4px;border:1px solid #ccc;border-radius:4px;"></div>' +
'<div class="survey-question"><p class="question-text">Q12. 理想のプリンセス像とはどんなものか（簡単な記述）</p><textarea name="q12" required rows="3" placeholder="例：自分の意志で行動し、周囲を思いやれる人" style="width:100%;padding:8px;box-sizing:border-box;margin-top:4px;border:1px solid #ccc;border-radius:4px;"></textarea></div>' +
'</fieldset>' +
'<button id="submitAndFinishBtn" type="submit">アンケートを回答し、データを送信する</button>';
    ...
    document.getElementById('submitAndFinishBtn').addEventListener('click', function(e) {
        ...
        var gasUrl = 'https://script.google.com/macros/s/AKfycbzrDKs-6wmeHDpyepiQNwW9ZcAAFtPRiasbNJtP8M0Pvlkxh5e04Km7eQh3mK1MOhHV/exec';
