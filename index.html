...
<body>　
    <div id="app" class="screen-container">
        ...
        <div id="screen2" class="screen">
            <h2>実験のやり方・注意事項</h2>
            <p>この実験では、様々な<strong>プリンセスの画像</strong>を画面に表示します。この白い画面は、あなたの<strong>「頭の中」や「思考のテーブル」</strong>だと思ってください。ドラッグ＆ドロップでプリンセスを動かすことは、机の上でカードを整理しながら、考えをまとめる作業と同じです。</p>
            <p>画面上の<strong>「距離」</strong>は、あなたの頭の中にある<strong>「関係性の強さ」</strong>を表します。あなただけの<strong>「頭の中の地図」</strong>を作るつもりで、楽しんで配置してみてください。特に、</strong>オーストラリアンミートパイ</strong>が他の食品と比べてどのあたりに位置するかを意識しながら、配置してみてください。</p>
            <div class="instructions-layout">
                <div class="instructions-text">
                    <ul>
                        <li>
                            <strong>配置フェーズ</strong>: 
                            画像の上にある<strong>青いバー</strong>をドラッグ＆ドロップして、自由に移動・配置してください。<br>
                            <ul>
                                <li><strong>「関連が強い」「一緒に思い浮かぶ」</strong>と感じるプリンセス同士は、<strong>物理的に近くに</strong>配置してください。</li>
                                <li>逆に「関連が薄い」「全く別の文脈で考える」プリンセス同士は、<strong>思い切って遠くに</strong>離してみてください。</li>
                                <li>２つのクラスターに属するプリンセスがあってもかまいません。その場合は、2つの円が重なる位置に配置してください。</li>
                                <li>少しでも円にプリンセスが触れていたら、クラスターの1つとして認識されます。</li>
                            </ul>
                            「関係性」に正解はありません。例えば、「格好が近い」「似たような性格をしている」「作品中の立ち振る舞いが類似している」といった、あなたが直感で感じる<strong>「つながり」</strong>を自由に表現してください。各プリンセスの上にある<strong>丸い[i]ボタン</strong>をクリックすると、その食品の情報を右側のパネルで確認できます。
                        </li>
                        <li>
                            <strong>クラスター作成フェーズ</strong>: 
                            全てのプリンセスを配置し終えたら、「配置を確定する」ボタンを押してください。その後、<strong>マウスで3つ以上のプリンセスを円で囲む</strong>ことでクラスター（グループ）を作成できます。
                        </li>
                        <li>
                            <strong>フィードバックフェーズ</strong>: 
                            全てのクラスターを作成し終えたら、「クラスターレビューへ進む」ボタンを押してください。その後、作成した各クラスターについて質問に回答していただきます。
                        </li>
                    </ul>
                </div>
                <div class="instructions-example">
                    <p><strong>【操作の例】</strong></p>
    
    <p>プリンセスの配置（ドラッグ＆ドロップ）</p>
    <video autoplay loop muted playsinline width="100%" style="border: 1px solid #ccc; border-radius: 8px; margin-bottom: 15px;">
        <source src="placement-demo.mp4" type="video/mp4">
        お使いのブラウザは動画の表示に対応していません。
    </video>
    
    <p>グループの作成（円で囲む）</p>
    <video autoplay loop muted playsinline width="100%" style="border: 1px solid #ccc; border-radius: 8px;">
        <source src="clustering-demo.mp4" type="video/mp4">
        お使いのブラウザは動画の表示に対応していません。
    </video>
                </div>
            </div>
...
<div id="screen3" class="screen">
            ...
            <div class="experiment-layout-container">
                ...
                <div id="details-panel" class="details-area">
                    ...
                    <img id="details-food-image" src="" alt="選択されたプリンセスの画像" style="display:none;">
                    <div id="details-food-info"></div>
                    <p id="details-placeholder" class="info-text" style="display:block;">プリンセスの[i]ボタンをクリックすると、ここに詳細情報が表示されます。</p>
                </div>
            </div>
